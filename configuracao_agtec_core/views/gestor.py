from configuracao_agtec_core.forms import GestorForm
...
class GestorListView(BaseListView):
    ...
    model = Gestor
    template_name = "configuracao_agtec_core/gestor/gestor_list.html"
...
class GestorDetailView(BaseDetailView):
    ...
    success_url = "configuracao_agtec_core:gestor-list"
    template_name = "configuracao_agtec_core/gestor/gestor_detail.html"
    context_object_name = "gestor"
...
class GestorCreateView(BaseCreateView):
    ...
    context_object_name = "gestor"
    success_url = "configuracao_agtec_core:gestor-list"
    template_name = "configuracao_agtec_core/gestor/gestor_create.html"
    # inlines = []
...
class GestorUpdateView(BaseUpdateView):
    ...
    context_object_name = "gestor"
    success_url = "configuracao_agtec_core:gestor-list"
    template_name = "configuracao_agtec_core/gestor/gestor_update.html"
    # inlines = []
...
class GestorDeleteView(BaseDeleteView):
    ...
    context_object_name = "gestor"
    success_url = "configuracao_agtec_core:gestor-list"
    template_name = "configuracao_agtec_core/gestor/gestor_delete.html"
...
class GestorRestoreView(BaseRestoreView):
    ...
    context_object_name = "gestor"
    success_url = "configuracao_agtec_core:gestor-list"
    template_name = "configuracao_agtec_core/gestor/gestor_restore.html"
