from configuracao_agtec_core.forms import LogoSistemaForm
...
class LogoSistemaListView(BaseListView):
    ...
    model = LogoSistema
    template_name = "configuracao_agtec_core/logosistema/logosistema_list.html"
...
class LogoSistemaDetailView(BaseDetailView):
    ...
    success_url = "configuracao_agtec_core:logosistema-list"
    template_name = "configuracao_agtec_core/logosistema/logosistema_detail.html"
    context_object_name = "logosistema"
...
class LogoSistemaCreateView(BaseCreateView):
    ...
    context_object_name = "logosistema"
    success_url = "configuracao_agtec_core:logosistema-list"
    template_name = "configuracao_agtec_core/logosistema/logosistema_create.html"
    # inlines = []
...
class LogoSistemaUpdateView(BaseUpdateView):
    ...
    context_object_name = "logosistema"
    success_url = "configuracao_agtec_core:logosistema-list"
    template_name = "configuracao_agtec_core/logosistema/logosistema_update.html"
    # inlines = []
...
class LogoSistemaDeleteView(BaseDeleteView):
    ...
    context_object_name = "logosistema"
    success_url = "configuracao_agtec_core:logosistema-list"
    template_name = "configuracao_agtec_core/logosistema/logosistema_delete.html"
...
class LogoSistemaRestoreView(BaseRestoreView):
    ...
    context_object_name = "logosistema"
    success_url = "configuracao_agtec_core:logosistema-list"
    template_name = "configuracao_agtec_core/logosistema/logosistema_restore.html"
