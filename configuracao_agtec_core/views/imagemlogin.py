from configuracao_agtec_core.forms import ImagemLoginForm
...
class ImagemLoginListView(BaseListView):
    ...
    model = ImagemLogin
    template_name = "configuracao_agtec_core/imagemlogin/imagemlogin_list.html"
...
class ImagemLoginDetailView(BaseDetailView):
    ...
    success_url = "configuracao_agtec_core:imagemlogin-list"
    template_name = "configuracao_agtec_core/imagemlogin/imagemlogin_detail.html"
    context_object_name = "imagemlogin"
...
class ImagemLoginCreateView(BaseCreateView):
    ...
    context_object_name = "imagemlogin"
    success_url = "configuracao_agtec_core:imagemlogin-list"
    template_name = "configuracao_agtec_core/imagemlogin/imagemlogin_create.html"
    # inlines = []
...
class ImagemLoginUpdateView(BaseUpdateView):
    ...
    context_object_name = "imagemlogin"
    success_url = "configuracao_agtec_core:imagemlogin-list"
    template_name = "configuracao_agtec_core/imagemlogin/imagemlogin_update.html"
    # inlines = []
...
class ImagemLoginDeleteView(BaseDeleteView):
    ...
    context_object_name = "imagemlogin"
    success_url = "configuracao_agtec_core:imagemlogin-list"
    template_name = "configuracao_agtec_core/imagemlogin/imagemlogin_delete.html"
...
class ImagemLoginRestoreView(BaseRestoreView):
    ...
    context_object_name = "imagemlogin"
    success_url = "configuracao_agtec_core:imagemlogin-list"
    template_name = "configuracao_agtec_core/imagemlogin/imagemlogin_restore.html"
