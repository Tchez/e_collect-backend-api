from configuracao_agtec_core.forms import DadosGeraisForm
...
class DadosGeraisListView(BaseListView):
    ...
    model = DadosGerais
    template_name = "configuracao_agtec_core/dadosgerais/dadosgerais_list.html"
...
class DadosGeraisDetailView(BaseDetailView):
    ...
    success_url = "configuracao_agtec_core:dadosgerais-list"
    template_name = "configuracao_agtec_core/dadosgerais/dadosgerais_detail.html"
    context_object_name = "dadosgerais"
...
class DadosGeraisCreateView(BaseCreateView):
    ...
    context_object_name = "dadosgerais"
    success_url = "configuracao_agtec_core:dadosgerais-list"
    template_name = "configuracao_agtec_core/dadosgerais/dadosgerais_create.html"
    # inlines = []
...
class DadosGeraisUpdateView(BaseUpdateView):
    ...
    context_object_name = "dadosgerais"
    success_url = "configuracao_agtec_core:dadosgerais-list"
    template_name = "configuracao_agtec_core/dadosgerais/dadosgerais_update.html"
    # inlines = []
...
class DadosGeraisDeleteView(BaseDeleteView):
    ...
    context_object_name = "dadosgerais"
    success_url = "configuracao_agtec_core:dadosgerais-list"
    template_name = "configuracao_agtec_core/dadosgerais/dadosgerais_delete.html"
...
class DadosGeraisRestoreView(BaseRestoreView):
    ...
    context_object_name = "dadosgerais"
    success_url = "configuracao_agtec_core:dadosgerais-list"
    template_name = "configuracao_agtec_core/dadosgerais/dadosgerais_restore.html"
