...
from configuracao_agtec_core.models import ImagemLogin
...
class TestImagemLoginViews:
    ...
    def test_imagemlogin_list(self, init):
        ...
        url = reverse("configuracao_agtec_core:imagemlogin-list")
    ...
    def test_imagemlogin_detail(self, init):
        ...
        url = reverse("configuracao_agtec_core:imagemlogin-detail", args={self.imagemlogin.pk})
        request = self.factory.get(url)
        request.user = self.user
    ...
    def test_imagemlogin_create(self, init):
        ...
        url = reverse("configuracao_agtec_core:imagemlogin-create")
        request = self.factory.get(url)
        request.user = self.user
    ...
    def test_imagemlogin_update(self, init):
        ...
        url = reverse("configuracao_agtec_core:imagemlogin-update", args={self.imagemlogin.pk})
    ...
    def test_imagemlogin_delete(self, init):
        ...
        url = reverse("configuracao_agtec_core:imagemlogin-delete", args={self.imagemlogin.pk})
    ...
    def test_imagemlogin_queryset_superuser_status(self, init, client):
        ...
        request = self.factory.get(reverse("configuracao_agtec_core:imagemlogin-list"))
        request.user = self.user
        response = ImagemLoginListView.as_view()(request)
        assert response.status_code == 200
