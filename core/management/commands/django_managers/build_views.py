        ...
        try:
            ...
            if hasattr(_model._meta, "fields_display") is True:
                content = content.replace(
                    "$ListFields$",
                    "list_display = {}".format(_model._meta.fields_display),
                )
            ...
            if Utils.check_content(
                self.path_model_views, "class {}ListView".format(self.model)
            ):
            ...
            if Utils.check_content(self.path_model_views, "from core.views"):
                ...
                arquivo = open(self.path_model_views, "r", encoding="utf-8")
                data = []
                ...
                arquivo = open(self.path_model_views, "w", encoding="utf-8")
