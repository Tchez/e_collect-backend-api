...
from core.views.base.utils import get_default_context_data
from core.views.utils import get_breadcrumbs


class BaseUpdateView(SuccessMessageMixin, LoginRequiredMixin, PermissionRequiredMixin, UpdateView):
    """
