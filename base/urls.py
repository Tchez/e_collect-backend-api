...
schema_view = get_schema_view(
    openapi.Info(
        title="E-Collect API",
        default_version="v1",
        description="Swagger do Projeto E-Collect API",
        terms_of_service="https://www.rede.ulbra.br/",
        contact=openapi.Contact(email="marcomartins06@rede.ulbra.br"),
        license=openapi.License(name="BSD License"),
    ),
    url="http://127.0.0.1:8000" if settings.DEBUG else "https://www.rede.ulbra.br",
    public=True,
)
